package kundtsTube.view{	
		...
		public class KundtsTubeMovieclip extends MovieClip{
			
			public function KundtsTubeMovieclip() {
			...
			public function createTextField1(obj:Object,isSelectable:Boolean,posX:Number,posY:Number,txtWidth:Number,format:TextFormat):TextField{
				var txtField:TextField = new TextField();
